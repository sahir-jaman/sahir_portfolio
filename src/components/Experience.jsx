  ...
  return (
    <div className="md:mt-[40px] mt-[10px]">
      <div id="MoveUpBD">
        ...
        <h2 className="text-[#2ecc71] text-[20px]">Technology: [ Django, React, Tailwind CSS, Django-Rest-Framework, PostgreSQL ]</h2>
      ...
      <div id="Repliq" className="mt-[60px]">
        ...
        <h2 className="text-[#2ecc71] text-[20px]">Technology: [ Django, Django-Rest-Framework, Celery, Redis, SQL ]</h2>
